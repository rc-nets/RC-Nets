function im_h_y = NIDCN_SWRB_13x13(im_l_y,model)
% 
% addpath ../
% load('convfea.mat');
...
convfea = vl_nnconv(im_y,weight{1},bias{1},'Pad',6);
...
convfea = vl_nnconv(convfea,weight{2},bias{2},'Pad',8);
...
convfea = vl_nnconv(convfea,weight{3},bias{3},'Pad',6);
...
convfea = vl_nnconv(convfea,weight{4},bias{4},'Pad',6);
...
convfea = vl_nnconv(convfea,weight{layer_num},bias{layer_num},'Pad',6);
%disp(size(convfea));
